...
While we're messing around with scales, let's mess with the coordinate system as well. How would that scatterplot look with a polar coordinate system? This isn't a great application of a polar coordinate sytem (they make the most sense with unordered or cyclical data), but here's how you would do it:
...
The creators of `ggplot2` don't like pie charts. If you disagree with them, you can hack a pie chart by wrapping a filled bar chart around a polar coordinate system.
...
With those building blocks as a foundation, I hope you will continue to play and explore with the many combinations of geometries, aesthetics, coordinate systems, and scales you can use to create creative and informative data visualizations!